...
<head>
    ...
    <title>Novo Vídeo - Institute History</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <h2 class="header">Novo Vídeo</h2>
            <div class="col s12">
                <form action="../includes/cadastro-video.php" method="POST" enctype="multipart/form-data" class="row">
                    ...
                    <div class="input-field col s12">
                        ...
                        <label for="textarea">O que este vídeo significa?</label>
                    </div>
